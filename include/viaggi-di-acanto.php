...
<div id="container_contenuti" rel="visite-guidate"> 
  ...
  <?php 
    $sqlArticolo2 = "SELECT * FROM `articolo` WHERE articolo_pagina_id = ".$paginaId." AND articolo_visibile = 1  AND articolo_id = 33 ";
  ...
  <!-- griglia img -->
   <div class="griglia-sezione griglia_viaggi">
     <center>
        <?php 
		  $sqlArticolo3 = "SELECT * FROM `articolo` WHERE articolo_pagina_id = ".$paginaId." AND articolo_visibile = 1 AND articolo_id != 33 ORDER BY articolo_data_modifica ASC  ";
