<?php
	  ...
	  $datePrevMonth = date('Y-m', strtotime('-1 month', strtotime($dateCurrentMonth)));
               ...
               $sqlArticolo5 = "SELECT * FROM `articolo` WHERE articolo_pagina_id = ".$paginaId." AND date(articolo_data_modifica) = '".$dateCurrentMonth."' AND articolo_id != 22 ORDER BY articolo_data_modifica ASC LIMIT 0,1 ";
