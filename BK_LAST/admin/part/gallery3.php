...
<!-- BEGIN --> 
		<div class="col-md-11  allineamentoBox no-border">
			...
			<div class="grid-title no-border">
				<h4>Sezione Home: <span class="semi-bold">Galleria Prodotti</span></h4>
			</div>
			<!-- END TITLE --> 
			<!-- BEGIN BODY --> 
			<div class="grid-body no-border">
                ...
                <input type="hidden" name="slid" value="3" />
...
<?php 
  ...
  $query = "SELECT * FROM `".$tab."_gallery` WHERE `slide_g` = 3  ORDER BY `id_g` ASC "; 
