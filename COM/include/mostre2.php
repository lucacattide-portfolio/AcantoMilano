          ...
          <div class="testoContainer">
			...
			/*
			   ...
			   $text2 = strip_tags($textA, '</p>');
				...
				if( str_word_count($articolo3["articolo_testo"]) > 150 ):
				  $pos=strpos($text2 , ' ', 750);
                substr($text2 ,0,$pos ); 
            ...
            <?php if( str_word_count($articolo3["articolo_testo"]) > 150 ): ?>
            
             <!--<span rel="<?php echo $articolo3["articolo_id"]; ?>" class="leggi leggitutto"> Read more </span>-->
             
           <?php endif; ?>  
           
           <div class="gradiente_testo nascondi">
		   </div>
           
          </div>
          
          <span rel="<?php echo $articolo3["articolo_id"]; ?>" class="leggi leggitutto read_more"> Read more </span>
