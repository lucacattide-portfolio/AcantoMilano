<?php 
				...
				if ($rowPaginaHt["pagina_dipendenza_id"] == "accordion") { // Se la pagina è un accordion
					...
					if ($countArticolo >= 1): // Se esiste almeno un record
						...
						while ($rowArticolo = $rArticolo->fetch_array()): // Allora finchè esistono pagine
							...
							$siteurl = "http://www.acantomilano.com/beta/"; // Allora inizializza l'url	
	...
	$siteurl_base = "http://www.acantomilano.com/beta/";
...
<html>
	...
	<head>
		...
		<script>
			...
			(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
				...
				})(window,document,'script','dataLayer','GTM-TJ4SL9');
	...
	<body>
		...
		<noscript>
        	...
        	<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TJ4SL9" height="0" width="0" style="display:none;visibility:hidden">
            </iframe>
